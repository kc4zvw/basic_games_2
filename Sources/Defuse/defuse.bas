...
30 PRINT "LONG(O-99), 100 ROOMS WIDE(0-99), AND 100 ROOMS HIGH(0-99)."
...
80 C=INT(100*RND(1)):IF A>O THEN 90 
85 IF B>O THEN 90 
87 IF C=O THEN 80 
90 D=0:E=0:F=0:G=0 
...
135 GOTO 180 
140 PRINT "BOOM!!!":PRINT "YOU BLEW IT. THE BUILDJN6 BLEW UP." 
...
165 GOTO 999
170 PRINT "BOMB DEACTIVATED AT "; G; " SECONDS 1":GOTO 150 
